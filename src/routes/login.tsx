  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-aura-bg px-6 text-aura-text">
      ...
      <motion.div
        ...
        className="chrome-field relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-aura-surface/80 p-10 backdrop-blur-xl"
      >
        ...
        >
          <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
            <path fill="#FFFFFF" d="M43.6 20.5h-1.9V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.3 4.1 29.4 2 24 2 11.8 2 2 11.8 2 24s9.8 22 22 22c11 0 21-8 21-22 0-1.2-.1-2.3-.4-3.5z" />
          </svg>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <label className="flex flex-col gap-2">
            ...
            <input
              ...
              className="focus-ring font-aura rounded-lg border border-white/10 bg-aura-bg2 px-4 py-3 text-sm text-aura-text outline-none transition-colors placeholder:text-aura-text-muted focus:border-white/30"
          ...
          <ChromeButton type="submit" disabled={submitting} className="mt-2 w-full">
            {submitting
              ? "Please wait…"
              : mode === "signin"
                ? "SIGN IN"
        ...
        <div className="chrome-line mx-auto mt-8 h-px w-2/3" />
        ...
        <p className="font-aura mt-6 text-center text-sm text-aura-text-secondary">
          ...
          <button
            ...
            className="font-aura text-aura-white underline-offset-4 transition-colors hover:underline"
          >
